...
$(document).ready(function () {
    ...
    '<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight">' +
        '<div class="offcanvas-header">' +
            ...
            '<button type="button" class="btn-close text-reset  icon-x" data-bs-dismiss="offcanvas" aria-label="Close"></button>' +
        '</div>' +
                    ...
                    '<div class="widget-content-inner active">' +
                        '<form class="form-theme-style">' +
                            ...
                            '<fieldset class="header-position">' +
                                ...
                                '</div>' +
                            '</fieldset>' +
                            '<div class="tf-btn-3 cursor-pointer button-clear-select">Clear all</div>' +
                        '</form>' +
                    '</div>' +
                            ...
                            '<fieldset class="">' +
                                ...
                                '<div class="select-colors-theme colors-theme-primary mb-10">' +
                                    ...
                                    '<div class="more-select">' +
                                        '<img src="images/bg-menu/more.png" alt="image">' +
                                    '</div>' +
                                '</div>' +
                            '</fieldset>' +
                            '<fieldset class="">' +
                                ...
                                '<div class="select-colors-theme colors-theme-background mb-10">' +
                                    '<div class="item color-F6F6F6 active default"></div>' +
