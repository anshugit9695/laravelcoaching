...
<section class="relative bg-teal py-28"
    ...
    <div class="container mx-auto px-4 relative z-10 text-center">
        <h1 class="text-5xl md:text-6xl font-extrabold text-white mb-4 uppercase tracking-wider">Franchise Agreements
        </h1>
        <div
...
<section class="container mx-auto px-4 py-20 max-w-7xl">
    <div class="grid gap-12 lg:grid-cols-[70%_30%] items-center">
        ...
        <!-- Left (70%) -->
        <div class="space-y-6">
            <h2 class="text-4xl font-bold text-navy">Franchise Agreements for Your Success</h2>
